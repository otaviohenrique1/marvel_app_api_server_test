const avengers = "../../services/api_teste/images/personagens/avengers.jpg";
const blackWidow = "../../services/api_teste/images/personagens/black_widow.jpg";
const captainAmerica = "../../services/api_teste/images/personagens/captain_america.jpg";
const guardiansOfTheGalaxy = "../../services/api_teste/images/personagens/guardians_of_the_galaxy.jpg";
const ironMan = "../../services/api_teste/images/personagens/iron_man.jpg";
const spiderMan = "../../services/api_teste/images/personagens/spider-man.jpg";
const wolverine = "../../services/api_teste/images/personagens/wolverine.jpg";
const xMen = "../../services/api_teste/images/personagens/x-men.jpg";
